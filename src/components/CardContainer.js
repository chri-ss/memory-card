const CardContainer = ({ allCards, markSeen }) => {
  ...
  return (
    <div className="flex w-full h-5/6 justify-center items-center bg-zinc-200 border border-black">
      <ul className="grid h-5/6 sm:w-4/6 lg:w-3/6 p-2 bg-slate-300 border border-black grid-cols-4 grid-rows-4 gap-2 justify-items-center align-content-center rounded-xl">
